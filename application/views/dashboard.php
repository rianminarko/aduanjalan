...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="dashboard">Sistem Pengaduan Jalan Rusak Kabupaten Pekalongan </a>
	...
	<div class="row">
		<div class="col-md-3">
			<div class="list-group">
			  ...
			  <a href="" class="list-group-item"><i class="fa fa-dashboard"></i> Daftar Laporan</a>
			  <a href="#" class="list-group-item"><i class="fa fa-book"></i> Laporan Saya</a>
			  <a href="#" class="list-group-item"><i class="fa fa-folder"></i> Statistik</a>
			  <a href="#" class="list-group-item"><i class="fa fa-comments-o"></i> Proposal</a>
